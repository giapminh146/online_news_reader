...
public final class NewsSavedRowBinding implements ViewBinding {
  @NonNull
  ...
  private NewsSavedRowBinding(@NonNull CardView rootView,
      @NonNull AppCompatImageButton bookmarkButton, @NonNull ImageView imgHeadline,
      @NonNull CardView mainContainer, @NonNull TextView textSource, @NonNull TextView textTime,
  ...
  @NonNull
  public static NewsSavedRowBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NewsSavedRowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.news_saved_row, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NewsSavedRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NewsSavedRowBinding((CardView) rootView, bookmarkButton, imgHeadline,
          mainContainer, textSource, textTime, textTitle);
    }
