    ...
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        ...
        holder.bookmarkButton.setOnClickListener(v -> {
            ...
            if (holder.isBookmarked) {
                holder.bookmarkButton.setImageResource(R.drawable.ic_bookmark_border);  // Unfilled bookmark icon
            } else {
                holder.bookmarkButton.setImageResource(R.drawable.ic_bookmark_filled);  // Gold bookmark icon
            }
            holder.isBookmarked = !holder.isBookmarked;  // Toggle the state
        });
    }
